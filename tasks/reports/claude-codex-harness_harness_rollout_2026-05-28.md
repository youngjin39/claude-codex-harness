...
Minimum patch plan: add Mir central-management block to `CLAUDE.md`; add template-safe `DispatchBrief` defaults; regenerate generated surfaces where supported
Applied patch summary: Mir central-management block added to `CLAUDE.md`; Mir generator/verifier copied in; generated surfaces refreshed; template baseline now carries tiny-normal-heavy triage and DispatchBrief default guidance
...
Rollback:
- remove the Mir central-management block and revert to pre-ADR-48 template wording
