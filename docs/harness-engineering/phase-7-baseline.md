...
> Purpose: Describe the classification and rollout baseline for multiple families.

## 0.5 Design Goals

- Keep the public template aligned with the mir-harness baseline for phase 7.
