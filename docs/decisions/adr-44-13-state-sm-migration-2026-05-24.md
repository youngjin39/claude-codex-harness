...
# ADR-44 — 13-State State-Machine Migration

## Context

The public template needs a stable reference record for ADR-44 so applied-state verification can confirm the baseline catalog is complete.
