...
# ADR-13 — Harness Generator Bootstrap

## Context

The public template needs a stable reference record for ADR-13 so applied-state verification can confirm the baseline catalog is complete.
