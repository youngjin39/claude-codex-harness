...
# ADR-22 — Sealed Family Policy

## Context

The public template needs a stable reference record for ADR-22 so applied-state verification can confirm the baseline catalog is complete.
