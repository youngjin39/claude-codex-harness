...
# ADR-45 — Error Taxonomy Unification

## Context

The public template needs a stable reference record for ADR-45 so applied-state verification can confirm the baseline catalog is complete.
