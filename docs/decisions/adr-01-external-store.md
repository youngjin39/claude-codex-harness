...
# ADR-01 — External Store

## Context

The public template needs a stable reference record for ADR-01 so applied-state verification can confirm the baseline catalog is complete.
