...
# ADR-14 — SQLite Memory Python Native

## Context

The public template needs a stable reference record for ADR-14 so applied-state verification can confirm the baseline catalog is complete.
