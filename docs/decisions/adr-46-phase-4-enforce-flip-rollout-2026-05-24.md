...
# ADR-46 — Phase-4 Enforce Flip Rollout

## Context

The public template needs a stable reference record for ADR-46 so applied-state verification can confirm the baseline catalog is complete.
