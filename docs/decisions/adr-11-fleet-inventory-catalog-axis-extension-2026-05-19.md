...
# ADR-11 — Fleet Inventory Catalog Axis Extension

## Context

The public template needs a stable reference record for ADR-11 so applied-state verification can confirm the baseline catalog is complete.
