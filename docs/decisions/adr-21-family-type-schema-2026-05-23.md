...
# ADR-21 — Family Type Schema

## Context

The public template needs a stable reference record for ADR-21 so applied-state verification can confirm the baseline catalog is complete.
