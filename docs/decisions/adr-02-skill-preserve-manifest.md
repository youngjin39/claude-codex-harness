...
# ADR-02 — Skill Preserve Manifest

## Context

The public template needs a stable reference record for ADR-02 so applied-state verification can confirm the baseline catalog is complete.
