...
# ADR-03 — Phase Gate Policy

## Context

The public template needs a stable reference record for ADR-03 so applied-state verification can confirm the baseline catalog is complete.
