...
# ADR-04 — CLAUDE.md Preserve Policy

## Context

The public template needs a stable reference record for ADR-04 so applied-state verification can confirm the baseline catalog is complete.
